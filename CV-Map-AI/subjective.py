...
class SubjectiveTest:
    def __init__(self, data, noOfQues, valid_keywords=None):
    ...
    def is_valid_chunk(self, chunk):
        # Check if the chunk contains any valid keyword
        ...
        for sentence in sentences:
            ...
            for subtree in tree.subtrees():
                if subtree.label() == "CHUNK":
                    ...
                    # Validate chunk against the list of keywords
                    if not self.is_valid_chunk(temp):
                        continue
